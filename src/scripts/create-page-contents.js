...
async function createPageContents() {
  console.log('Sayfa içerikleri oluşturuluyor...');
  ...
  for (const content of pageContents) {
    try {
      ...
      if (existingContent) {
        console.log(`"${content.pageKey}" anahtarına sahip içerik zaten mevcut, güncelleniyor...`);
        ...
        console.log(`"${content.pageKey}" içeriği güncellendi.`);
      } else {
        console.log(`"${content.pageKey}" anahtarına sahip yeni içerik oluşturuluyor...`);
        ...
        console.log(`"${content.pageKey}" içeriği oluşturuldu.`);
      }
    } catch (error) {
      console.error(`"${content.pageKey}" içeriği işlenirken hata oluştu:`, error);
    }
  }
