        ...
        <>
          <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              <Popover.Group className="flex items-center gap-x-12">
                ...
                {session && (
                  <Popover className="relative">
                    ...
                    >
                      <Popover.Panel className={`absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0 focus:outline-none ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                  ...
                  <Popover.Group>
                    <Popover className="relative">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0 translate-y-1"
                      >
                        <Popover.Panel className={`absolute right-0 z-10 mt-3 w-screen max-w-xs transform px-2 sm:px-0 focus:outline-none ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                          <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="relative grid gap-6 px-5 py-6 sm:gap-8 sm:p-8">
          ...
          >
            <Popover.Panel focus className={`absolute inset-x-0 top-0 origin-top-right transform p-2 transition md:hidden focus:outline-none ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
