                  ...
                  <div className="flex flex-col space-y-4">
                    <div className="w-full">
                      ...
                      <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                        <p className={`text-lg sm:text-2xl font-mono tracking-wider ${theme === 'dark' ? 'text-white' : 'text-gray-900'} break-all sm:break-normal`}>
                        ...
                        >
                          ...
                          <span className="ml-2 sm:hidden">Kopyala</span>
                        </button>
                      </div>
                    </div>
                  </div>
